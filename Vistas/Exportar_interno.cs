...
namespace Indicador_de_acciones_Calidad
{
    public partial class Exportar_interno : Form
    {
        ...
        public void mes() {
            ...
            try
            {
                string consulta = "SELECT MES FROM proyecto.dbo.Indicador_acciones "; //Consulta a MySQL (Muestra las bases de datos que tiene el servidor)
        ...
        public void detalle()
        {
            ...
            try
            {
                string consulta = "SELECT detallado FROM proyecto.dbo.Indicador_acciones "; //Consulta a MySQL (Muestra las bases de datos que tiene el servidor)
                SqlCommand comando = new SqlCommand(consulta)
                {
                    Connection = connecting //Establece la MySqlConnection utilizada por esta instancia de MySqlCommand
                }; //Declaración SQL para ejecutar contra una base de datos MySQL
        ...
        public void area()
        {
            ...
            try
            {
                string consulta = "SELECT area FROM proyecto.dbo.Indicador_acciones "; //Consulta a MySQL (Muestra las bases de datos que tiene el servidor)
                SqlCommand comando = new SqlCommand(consulta)
                {
                    Connection = connecting //Establece la MySqlConnection utilizada por esta instancia de MySqlCommand
                }; //Declaración SQL para ejecutar contra una base de datos MySQL
        ...
        public void ExportMes(string variable) {
           ...
           using (FolderBrowserDialog fd = new FolderBrowserDialog())
           {
               if (fd.ShowDialog() == System.Windows.Forms.DialogResult.OK && !string.IsNullOrWhiteSpace(fd.SelectedPath))
               {
                   ...
                   try
                   {
                       string consulta = "SELECT * FROM proyecto.dbo.Indicador_acciones WHERE MES='"+variable+"' "; //Consulta a MySQL (Muestra las bases de datos que tiene el servidor)
                       SqlCommand comando = new SqlCommand(consulta)
                       {
                           Connection = connecting //Establece la MySqlConnection utilizada por esta instancia de MySqlCommand
                       }; //Declaración SQL para ejecutar contra una base de datos MySQL
        ...
        public void ExportDetalle(string variable)
        {
            ...
            using (FolderBrowserDialog fd = new FolderBrowserDialog())
            {
                if (fd.ShowDialog() == System.Windows.Forms.DialogResult.OK && !string.IsNullOrWhiteSpace(fd.SelectedPath))
                {
                    ...
                    try
                    {
                        string consulta = "SELECT * FROM proyecto.dbo.Indicador_acciones WHERE detallado='" + variable + "' "; //Consulta a MySQL (Muestra las bases de datos que tiene el servidor)
                        SqlCommand comando = new SqlCommand(consulta)
                        {
                            Connection = connecting //Establece la MySqlConnection utilizada por esta instancia de MySqlCommand
                        }; //Declaración SQL para ejecutar contra una base de datos MySQL
        ...
        public void ExportArea(string variable)
        {
            ...
            using (FolderBrowserDialog fd = new FolderBrowserDialog())
            {
                if (fd.ShowDialog() == System.Windows.Forms.DialogResult.OK && !string.IsNullOrWhiteSpace(fd.SelectedPath))
                {
                    ...
                    try
                    {
                        string consulta = "SELECT * FROM proyecto.dbo.Indicador_acciones WHERE area='" + variable + "' "; //Consulta a MySQL (Muestra las bases de datos que tiene el servidor)
                        SqlCommand comando = new SqlCommand(consulta)
                        {
                            Connection = connecting //Establece la MySqlConnection utilizada por esta instancia de MySqlCommand
                        }; //Declaración SQL para ejecutar contra una base de datos MySQL
