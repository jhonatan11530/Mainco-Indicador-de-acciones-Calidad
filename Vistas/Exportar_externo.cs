...
{
    public partial class Exportar_externo : Form
    {
        private int num = 9;
        public Exportar_externo()
        {
            InitializeComponent();
        ...
        public void mes()
        {
            ...
            try
            {
                string consulta = "SELECT MES FROM proyecto.dbo.Indicador_acciones WHERE verificado='EXTERNO' "; //Consulta a MySQL (Muestra las bases de datos que tiene el servidor)
        ...
        public void detalle()
        {
            ...
            try
            {
                string consulta = "SELECT detallado FROM proyecto.dbo.Indicador_acciones WHERE verificado='EXTERNO'"; //Consulta a MySQL (Muestra las bases de datos que tiene el servidor)
                SqlCommand comando = new SqlCommand(consulta)
                {
                    Connection = connecting //Establece la MySqlConnection utilizada por esta instancia de MySqlCommand
                }; //Declaración SQL para ejecutar contra una base de datos MySQL
        ...
        public void area()
        {
            ...
            try
            {
                string consulta = "SELECT area FROM proyecto.dbo.Indicador_acciones WHERE verificado='EXTERNO'"; //Consulta a MySQL (Muestra las bases de datos que tiene el servidor)
                SqlCommand comando = new SqlCommand(consulta)
                {
                    Connection = connecting //Establece la MySqlConnection utilizada por esta instancia de MySqlCommand
                }; //Declaración SQL para ejecutar contra una base de datos MySQL
        ...
        public void ExportMes(string variable)
        {
            ...
            using (FolderBrowserDialog fd = new FolderBrowserDialog())
            {
                if (fd.ShowDialog() == System.Windows.Forms.DialogResult.OK && !string.IsNullOrWhiteSpace(fd.SelectedPath))
                {
                    ...
                    try
                    {
                        string consulta = "SELECT * FROM proyecto.dbo.Indicador_acciones WHERE MES='" + variable + "' AND verificado='EXTERNO' "; //Consulta a MySQL (Muestra las bases de datos que tiene el servidor)
                        SqlCommand comando = new SqlCommand(consulta)
                        {
                            Connection = connecting //Establece la MySqlConnection utilizada por esta instancia de MySqlCommand
                        }; //Declaración SQL para ejecutar contra una base de datos MySQL
        ...
        public void ExportDetalle(string variable)
        {
            ...
            using (FolderBrowserDialog fd = new FolderBrowserDialog())
            {
                if (fd.ShowDialog() == System.Windows.Forms.DialogResult.OK && !string.IsNullOrWhiteSpace(fd.SelectedPath))
                {
                    ...
                    try
                    {
                        string consulta = "SELECT * FROM proyecto.dbo.Indicador_acciones WHERE detallado='" + variable + "' AND verificado='EXTERNO' "; //Consulta a MySQL (Muestra las bases de datos que tiene el servidor)
                        SqlCommand comando = new SqlCommand(consulta)
                        {
                            Connection = connecting //Establece la MySqlConnection utilizada por esta instancia de MySqlCommand
                        }; //Declaración SQL para ejecutar contra una base de datos MySQL
        ...
        public void ExportArea(string variable)
        {
            ...
            using (FolderBrowserDialog fd = new FolderBrowserDialog())
            {
                if (fd.ShowDialog() == System.Windows.Forms.DialogResult.OK && !string.IsNullOrWhiteSpace(fd.SelectedPath))
                {
                    ...
                    try
                    {
                        string consulta = "SELECT * FROM proyecto.dbo.Indicador_acciones WHERE area='" + variable + "' AND  verificado='EXTERNO'"; //Consulta a MySQL (Muestra las bases de datos que tiene el servidor)
                        SqlCommand comando = new SqlCommand(consulta)
                        {
                            Connection = connecting //Establece la MySqlConnection utilizada por esta instancia de MySqlCommand
                        }; //Declaración SQL para ejecutar contra una base de datos MySQL
        ...
        private void Exportar_externo_FormClosing(object sender, FormClosingEventArgs e)
        {
